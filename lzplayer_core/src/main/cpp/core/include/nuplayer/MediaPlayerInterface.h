...
public:
    ...
    public:
        ...
        virtual media::VolumeShaper::Status applyVolumeShaper(
                                    ...
                                    const std::shared_ptr<media::VolumeShaper::Operation>& operation) = 0;
        virtual std::shared_ptr<media::VolumeShaper::State> getVolumeShaperState(int id) = 0;
    ...
    virtual status_t    setDataSource(const std::shared_ptr<IStreamSource>& /* source */) {
        return INVALID_OPERATION;
    }

    virtual status_t    setDataSource(const std::shared_ptr<DataSource>& /* source */) {
        return INVALID_OPERATION;
    }
    ...
    virtual status_t    setVideoSurfaceTexture(
                                const std::shared_ptr<IGraphicBufferProducer>& bufferProducer) = 0;
    ...
    virtual status_t setNextPlayer(const std::shared_ptr<MediaPlayerBase>& /* next */) {
        return OK;
    }
...
public:
    ...
    virtual void        setAudioSink(const std::shared_ptr<AudioSink>& audioSink) { mAudioSink = audioSink; }
protected:
