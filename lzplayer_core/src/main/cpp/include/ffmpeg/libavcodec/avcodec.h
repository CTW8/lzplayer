...
typedef struct AVCodecContext {
     ...
     * - decoding: Set by user, will be converted to uppercase by libavcodec during prepare.
     */
...
typedef struct AVHWAccel {
     ...
     * details.
     *
     * This CAN be called before AVHWAccel.prepare is called, and you must assume
