...
VEAudioSLESRender::VEAudioSLESRender() : engineObject(nullptr), engineEngine(nullptr), outputMixObject(nullptr), playerObject(nullptr), playerPlay(nullptr), bufferQueue(nullptr) {}
...
int VEAudioSLESRender::initOpenSLES() {
    ...
    SLDataFormat_PCM format_pcm = {
        SL_DATAFORMAT_PCM, static_cast<SLuint32>(m_Config.channels), static_cast<SLuint32>(m_Config.sampleRate * 1000),
        static_cast<SLuint32>(m_Config.sampleFormat), static_cast<SLuint32>(m_Config.sampleFormat),
    ...
    (*engineEngine)->CreateAudioPlayer(engineEngine, &playerObject, &audioSrc, &audioSnk, 1, ids1, req1);
