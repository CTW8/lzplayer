...
| 步骤6 性能 HUD | Todo | **疑似被取代，待用户确认** | commit `13e4c21` 的常驻仪表带（竖屏两行八格 + 横屏左下 HUD 常驻）已覆盖本步骤意图。**未经用户确认不擅自标 Done** |
...
- [ ] 步骤7: 基准序列（跑分报告）—— **本次开工项，已拆为 7a~7f，见 plan.md**
  ...
  - **范围收窄**：原 6 步序列的第 4 步（三档变速）与第 5 步（音轨/字幕切换）**推迟** ——
    「变速生效耗时」「切轨耗时」目前**没有任何采集点**，现在做只能产出没有数字的章节。
    v1 覆盖第 1/2/3/6 步。
...
- [ ] 步骤6: 性能 HUD（主控台左下角三行小字 + 开关）—— **疑似已被 console-ui-v2
  的常驻仪表带取代（commit `13e4c21`：竖屏两行八格 + 横屏左下 HUD 常驻），
  待用户确认后关闭；未经确认不擅自标 Done**
