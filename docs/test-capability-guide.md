...
> 架构全貌见 [test-system.html](test-system.html)（浏览器打开）——那份讲"系统怎么组织
> 的、为什么这么组织"；本文讲"要用它做某件事该敲什么命令"。
...
- 泄漏判据样本 `< 600 秒` 判 INCONCLUSIVE，不硬算斜率——**实证**：5 分钟样本测得
  RSS +41.6 MB/小时，30 分钟测得 +3.6，**相差 11 倍**，短样本斜率被正常波动主导
